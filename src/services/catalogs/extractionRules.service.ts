...
export const getExtractionRules = async (
...
export const getExtractionAllRules = async (filters?: GetFilters) => {
  try {
...
export const getExtractionRuleById = async (
    uuid: string
): Promise<RuleState> => {
    try {
...
export const createExtractionRule = async (data: Partial<RuleState> ) => {
  try {
...
export const updateExtractionRule = async (id: string, data: Partial<RuleState> ) => {
  try {
...
export const deleteExtractionRule = async (id: string) => {
  try {
