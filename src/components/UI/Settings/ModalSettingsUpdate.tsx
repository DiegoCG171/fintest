...
export const ModalSettingsUpdate = () => {
  const dispatch = useAppDispatch();
  const { modalIsOpen, updateUser } = useAppSelector((state) => state.admin);
      ...
      <Modal open={modalIsOpen}>
        <Box sx={modalStyle}>
          ...
          <Typography sx={{ mt: 2 }}>
            ...
            sistema. Podrás modificar sus roles, institución y estado de la
          ...
          >
            ...
            <FormControl>
              ...
              <Select
                ...
                onChange={(e) => setUser({ ...user, roles: [{...user.roles![0], name: e.target.value}, ...user.roles!] })}
                label="Roles"
              >
