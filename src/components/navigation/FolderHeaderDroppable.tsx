...
export default function FolderHeaderDroppable({
    ...
    const backgroundColor = useMemo(() => {
        ...
        return "transparent";
    }, [expanded, isOver, overId, item.id, depth, theme.palette.secondary.light, theme.palette.background.default]);
    ...
    return (
        ...
        {renderEditNodeEditor?.(item) ?? (
            ...
            {optionsActive && (
                ...
                onClick={(e) => {
                    e.stopPropagation();
                    const options = buildOptions?.(item) || buildSubItemOptions?.(item);
